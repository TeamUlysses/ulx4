-- Downloaded from github.com/leafo/tableshape on Tue Jan 26 09:43:56 EST 2016
-- Original was modified to load into the global space, since Garrys Mod doesnt support Lua best practices
class BaseType
  @is_base_type: (val) =>
...
export tableshape = { :check_shape, :types, :BaseType, VERSION: "1.1.0" }
